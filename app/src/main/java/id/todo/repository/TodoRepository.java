...
public class TodoRepository {
    ...
    private String[] allColumn = new String[]{
            TableTodos.COLUMN_ID,
            TableTodos.COLUMN_ITEM,
            TableTodos.COLUMN_SYNCHRONIZED,
            TableTodos.COLUMN_TIMESTAMP
    };
    ...
    public void insert(Todo itemTodo){
        ...
        contentValues.put(TableTodos.COLUMN_ITEM,itemTodo.item);
        contentValues.put(TableTodos.COLUMN_ID,itemTodo.id);
        database.insert(TableTodos.TABLE_NAME, null, contentValues);
    }

    public Todo find(Todo todo){
        Cursor cursor = database.query(TableTodos.TABLE_NAME, allColumn,
                TableTodos.COLUMN_ID + "=\"" +
                        todo.id+"\"", null, null, null, null);
        cursor.moveToNext();
